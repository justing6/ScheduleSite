...
<ul class="nav" style="width:97%;z-index:3">
    ...
    <li id="options">
        <a href="##">Admin</a>
        <ul class="subnav" style="z-index:2;">
			<li><a href="/admin.cfm"><font size="2px;">Manage Reservations</font></a></li>
            <li><a href="/rooms.cfm"><font size="2px;">Manage Rooms</font></a></li>
        </ul>
    </li>
    <li id="options">
        <a href="##">Options</a>
